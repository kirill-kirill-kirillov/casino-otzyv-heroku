...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210817_mysite_29116bcfb22897e85418_20210817185805_archive.zip';
	const ARCHIVE_SIZE		 = '81949283';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '29116bc-17185805';
    const SECONDARY_PACKAGE_HASH = 'fabe696-17185805';
	const VERSION			 = '1.4.2';
